...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// pctBx
			// 
			this->pctBx->BackColor = System::Drawing::Color::DarkRed;
			...
			this->txt_source->Text = L"text_source";
			// 
			// txt_destination
			// 
			...
			this->gpBox_typeProcessus->Size = System::Drawing::Size(575, 54);
			...
			this->btn_proceder->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btn_proceder->ForeColor = System::Drawing::Color::Red;
			...
			// txt_rslt
			// 
			this->txt_rslt->BackColor = System::Drawing::SystemColors::ActiveCaption;
			...
			this->ClientSize = System::Drawing::Size(1051, 459);
...
///									   ||||              ajouté                         |||||
	private: System::Void btn_source_Click(System::Object^ sender ,System::EventArgs^ e)
	{
		...
		// ajouté apres erreur de classe non définie
	...
	private: System::Void btn_proceder_Click(System::Object^ sender, System::EventArgs^ e)
	{
		...
		{
			this->pctBx->Image = image->lireImage("C:\\Users\\alexd\\Pictures\\acceuil.png");
			this->svcFichier->effacer(this->listeDeFichier);
			this->txt_rslt->Clear();
			this->txt_rslt->Text = "Les fichiers ont été effacés dans le dossier : " + this->txt_destination->Text;
		}
		////////////ajouté
	}
